...
class AddDirectionViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
...
//        self.directionTableDelegate!.addRouteViewControllerDismissed(direction)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        var cell : UITableViewCell = self.tableView.dequeueReusableCellWithIdentifier("AddDirectionCell") as UITableViewCell
